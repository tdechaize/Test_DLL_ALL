...
REM    avec le compilateur GCC inclus dans Mingw64 récupéré du package winlibs.
REM
...
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objMINGW32WL\Release\%%a.o -c src\%%a.c
		 call :concat objMINGW32WL\Release\%%a.o
		 )
)
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32WL\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32WL\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -mconsole -s -L"%LIB%" %OBJS% objMINGW32WL\Release\%NAME_APPLI%.o objMINGW32WL\Release\%NAME_APPLI%.res -o binMINGW32WL\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m32 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objMINGW32WL\Debug\%%a.o -c src\%%a.c
		 call :concat objMINGW32WL\Debug\%%a.o
		 )
)
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32WL\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32WL\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -mconsole -L"%LIB%" %OBJS% objMINGW32WL\Debug\%NAME_APPLI%.o objMINGW32WL\Debug\%NAME_APPLI%.res -o binMINGW32WL\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32WL\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32WL\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -mwindows -s -L"%LIB%" %OBJS% objMINGW32WL\Release\%NAME_APPLI%.o objMINGW32WL\Release\%NAME_APPLI%.res -o binMINGW32WL\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-m32 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32WL\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32WL\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -mwindows -L"%LIB%" %OBJS% objMINGW32WL\Debug\%NAME_APPLI%.o objMINGW32WL\Debug\%NAME_APPLI%.res -o binMINGW32WL\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
ar ru binMINGW32WL\Release\lib%NAME_APPLI%.a %OBJS% objMINGW32WL\Release\%NAME_APPLI%.o
gcc -m32 -L"%LIB%" -o binMINGW32WL\Release\%NAME_APPLI%.lib %OBJS% objMINGW32WL\Release\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBLIB
set "CFLAGS=-m32 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
ar ru binMINGW32WL\Debug\lib%NAME_APPLI%.a %OBJS% objMINGW32WL\Debug\%NAME_APPLI%.o
gcc -m32 -L"%LIB%" -o binMINGW32WL\Debug\%NAME_APPLI%.lib %OBJS% objMINGW32WL\Debug\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN

:DLLA
echo "GCC 32b Mingw32 packagé Winlibs -> Genération d'une librairie partagée (.ie. DLL) en mode : %4"
if "%4"=="Debug" goto DEBDLL
set "CFLAGS=-O2 -m32 -fPIC -DNDEBUG"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objMINGW32WL\Release\%%a.o -c src\%%a.c
		 call :concat objMINGW32WL\Release\%%a.o
...
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32WL\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32WL\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -shared -s -L"%LIB%" -Wl,--out-implib,binMINGW32WL\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objMINGW32WL\Release\%NAME_APPLI%.o objMINGW32WL\Release\%NAME_APPLI%.res -o binMINGW32WL\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBDLL
set "CFLAGS=-m32 -g -fPIC -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objMINGW32WL\Debug\%%a.o -c src\%%a.c
		 call :concat objMINGW32WL\Debug\%%a.o
...
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32WL\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32WL\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -shared -L"%LIB%" -Wl,--out-implib,binMINGW32WL\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objMINGW32WL\Debug\%NAME_APPLI%.o objMINGW32WL\Debug\%NAME_APPLI%.res -o binMINGW32WL\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
