...
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         i686-w64-mingw32-gcc %CFLAGS% -I%INCLUDE% -o objDEVCPP\Release\%%a.o -c src\%%a.c
		 call :concat objDEVCPP\Release\%%a.o
		 )
)
gcc %CFLAGS% -I"%INCLUDE%" -o objDEVCPP\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I"%INCLUDE%" -o objDEVCPP\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -mconsole -s -L"%LIB%" %OBJS% objDEVCPP\Release\%NAME_APPLI%.o objDEVCPP\Release\%NAME_APPLI%.res -o binDEVCPP\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m64 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         i686-w64-mingw32-gcc %CFLAGS% -I%INCLUDE% -o objDEVCPP\Debug\%%a.o -c src\%%a.c
		 call :concat objDEVCPP\Debug\%%a.o
		 )
)
gcc %CFLAGS% -I"%INCLUDE%" -o objDEVCPP\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I"%INCLUDE%" -o objDEVCPP\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -mconsole -L"%LIB%" %OBJS% objDEVCPP\Debug\%NAME_APPLI%.o objDEVCPP\Debug\%NAME_APPLI%.res -o binDEVCPP\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -I"%INCLUDE%" -o objDEVCPP\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I"%INCLUDE%" -o objDEVCPP\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -mwindows -s -L"%LIB%" %OBJS% objDEVCPP\Release\%NAME_APPLI%.o objDEVCPP\Release\%NAME_APPLI%.res -o binDEVCPP\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-m64 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
gcc %CFLAGS% -I"%INCLUDE%" -o objDEVCPP\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I"%INCLUDE%" -o objDEVCPP\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -mwindows -L"%LIB%" %OBJS% objDEVCPP\Debug\%NAME_APPLI%.o objDEVCPP\Debug\%NAME_APPLI%.res -o binDEVCPP\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
ar ru binDEVCPP\Release\lib%NAME_APPLI%.a %OBJS% objDEVCPP\Release\%NAME_APPLI%.o
gcc -L"%LIB%" -o binDEVCPP\Release\%NAME_APPLI%.lib %OBJS% objDEVCPP\Release\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBLIB
set "CFLAGS=-m64 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
ar ru binDEVCPP\Debug\lib%NAME_APPLI%.a %OBJS% objDEVCPP\Debug\%NAME_APPLI%.o
gcc -L"%LIB%" -o binDEVCPP\Debug\%NAME_APPLI%.lib %OBJS% objDEVCPP\Debug\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -I"%INCLUDE%" -o objDEVCPP\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I"%INCLUDE%" -o objDEVCPP\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -shared -s -L"%LIB%" -Wl,--out-implib,binDEVCPP\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objDEVCPP\Release\%NAME_APPLI%.o objDEVCPP\Release\%NAME_APPLI%.res -o binDEVCPP\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBDLL
...
gcc %CFLAGS% -I"%INCLUDE%" -o objDEVCPP\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I"%INCLUDE%" -o objDEVCPP\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -shared -L"%LIB%" -Wl,--out-implib,binDEVCPP\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objDEVCPP\Debug\%NAME_APPLI%.o objDEVCPP\Debug\%NAME_APPLI%.res -o binDEVCPP\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
