...
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objMSYS2W64\Release\%%a.o -c src\%%a.c
		 call :concat objMSYS2W64\Release\%%a.o
		 )
)
gcc %CFLAGS% -I%INCLUDE% -o objMSYS2W64\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMSYS2W64\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -mconsole -s -L"%LIB%" %OBJS% objMSYS2W64\Release\%NAME_APPLI%.o objMSYS2W64\Release\%NAME_APPLI%.res -o binMSYS2W64\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m64 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objMSYS2W64\Debug\%%a.o -c src\%%a.c
		 call :concat objMSYS2W64\Debug\%%a.o
		 )
)
gcc %CFLAGS% -I%INCLUDE% -o objMSYS2W64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMSYS2W64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -mconsole -L"%LIB%" %OBJS% objMSYS2W64\Debug\%NAME_APPLI%.o objMSYS2W64\Debug\%NAME_APPLI%.res -o binMSYS2W64\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -I%INCLUDE% -o objMSYS2W64\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMSYS2W64\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -mwindows -s -L"%LIB%" %OBJS% objMSYS2W64\Release\%NAME_APPLI%.o objMSYS2W64\Release\%NAME_APPLI%.res -o binMSYS2W64\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-m64 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
gcc %CFLAGS% -I%INCLUDE% -o objMSYS2W64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMSYS2W64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -mwindows -L"%LIB%" %OBJS% objMSYS2W64\Debug\%NAME_APPLI%.o objMSYS2W64\Debug\%NAME_APPLI%.res -o binMSYS2W64\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
ar ru binMSYS2W64\Release\lib%NAME_APPLI%.a %OBJS% objMSYS2W64\Release\%NAME_APPLI%.o
gcc -m64 -o binMSYS2W64\Release\%NAME_APPLI%.lib %OBJS% objMSYS2W64\Release\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBLIB
set "CFLAGS=-m64 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
ar ru binMSYS2W64\Debug\lib%NAME_APPLI%.a %OBJS% objMSYS2W64\Debug\%NAME_APPLI%.o
gcc -m64 -o binMSYS2W64\Debug\%NAME_APPLI%.lib %OBJS% objMSYS2W64\Debug\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -I%INCLUDE% -o objMSYS2W64\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMSYS2W64\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -shared -s -L"%LIB%" -Wl,--out-implib,binMSYS2W64\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objMSYS2W64\Release\%NAME_APPLI%.o objMSYS2W64\Release\%NAME_APPLI%.res -o binMSYS2W64\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBDLL
...
gcc %CFLAGS% -I%INCLUDE% -o objMSYS2W64\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMSYS2W64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -shared -L"%LIB%" -Wl,--out-implib,binMSYS2W64\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objMSYS2W64\Debug\%NAME_APPLI%.o objMSYS2W64\Debug\%NAME_APPLI%.res -o binMSYS2W64\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
