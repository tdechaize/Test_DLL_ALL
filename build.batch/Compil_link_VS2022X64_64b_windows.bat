...
lib /MACHINE:X64 /subsystem:windows /out:binVS2022X64\Release\%NAME_APPLI%.lib %OBJS% objVS2022X64\Release\%NAME_APPLI%.obj 
goto FIN
:DEBLIB
set "CFLAGS=/nologo /TC /Zi /DDEBUG /D_DEBUG"
if exist %1\src_c.txt (
...
lib /MACHINE:X64 /subsystem:windows /out:binVS2022X64\Debug\%NAME_APPLI%.lib %OBJS% objVS2022X64\Debug\%NAME_APPLI%.obj 
goto FIN
