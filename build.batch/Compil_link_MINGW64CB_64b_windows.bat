...
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objMingw64CB\Release\%%a.o -c src\%%a.c
		 call :concat objMingw64CB\Release\%%a.o
		 )
)
gcc %CFLAGS% -I%INCLUDE% -o objMingw64CB\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMingw64CB\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -mconsole -s -L"%LIB%" %OBJS% objMingW64CB\Release\%NAME_APPLI%.o objMingW64CB\Release\%NAME_APPLI%.res -o binMinGW64CB\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m64 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objMingw64CB\Debug\%%a.o -c src\%%a.c
		 call :concat objMingw64CB\Debug\%%a.o
		 )
)
gcc %CFLAGS% -I%INCLUDE% -o objMingw64CB\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMingw64CB\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -mconsole -L"%LIB%" %OBJS% objMingW64CB\Debug\%NAME_APPLI%.o objMingW64CB\Debug\%NAME_APPLI%.res -o binMinGW64CB\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -I%INCLUDE% -o objMingw64CB\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMingw64CB\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -mwindows -s -L"%LIB%" %OBJS% objMingW64CB\Release\%NAME_APPLI%.o objMingW64CB\Release\%NAME_APPLI%.res -o binMinGW64CB\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-m64 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
gcc %CFLAGS% -I%INCLUDE% -o objMingw64CB\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMingw64CB\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -mwindows -L"%LIB%" %OBJS% objMingW64CB\Debug\%NAME_APPLI%.o objMingW64CB\Debug\%NAME_APPLI%.res -o binMinGW64CB\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
ar ru binMinGW64CB\Release\lib%NAME_APPLI%.a %OBJS% objMingw64CB\Release\%NAME_APPLI%.o
gcc -L"%LIB%" -o binMinGW64CB\Release\%NAME_APPLI%.lib %OBJS% objMingw64CB\Release\%NAME_APPLI%.o
goto FIN
:DEBLIB
set "CFLAGS=-m64 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
ar ru binMinGW64CB\Debug\lib%NAME_APPLI%.a %OBJS% objMingw64CB\Debug\%NAME_APPLI%.o
gcc -L"%LIB%" -o binMinGW64CB\Debug\%NAME_APPLI%.lib %OBJS% objMingw64CB\Debug\%NAME_APPLI%.o
goto FIN
...
gcc %CFLAGS% -I%INCLUDE% -o objMingw64CB\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMingw64CB\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m64 -shared -s -L"%LIB%" -Wl,--out-implib,binMinGW64CB\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objMingW64CB\Release\%NAME_APPLI%.o objMingW64CB\Release\%NAME_APPLI%.res -o binMinGW64CB\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBDLL
...
gcc %CFLAGS% -I%INCLUDE% -o objMingw64CB\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMingw64CB\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m64 -shared -L"%LIB%" -Wl,--out-implib,binMinGW64CB\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objMingW64CB\Debug\%NAME_APPLI%.o objMingW64CB\Debug\%NAME_APPLI%.res -o binMinGW64CB\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
