...
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objTDMW32\Release\%%a.o -c src\%%a.c
		 call :concat objTDMW32\Release\%%a.o
		 )
)
gcc %CFLAGS% -I%INCLUDE% -o objTDMW32\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW32\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -mconsole -s -L"%LIB%" %OBJS% objTDMW32\Release\%NAME_APPLI%.o objTDMW32\Release\%NAME_APPLI%.res -o binTDMW32\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m32 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objTDMW32\Debug\%%a.o -c src\%%a.c
		 call :concat objTDMW32\Debug\%%a.o
		 )
)
gcc %CFLAGS% -I%INCLUDE% -o objTDMW32\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -mconsole -L"%LIB%" %OBJS% objTDMW32\Debug\%NAME_APPLI%.o objTDMW32\Debug\%NAME_APPLI%.res -o binTDMW32\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -I%INCLUDE% -o objTDMW32\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW32\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -mwindows -s -L"%LIB%" %OBJS% objTDMW32\Release\%NAME_APPLI%.o objTDMW32\Release\%NAME_APPLI%.res -o binTDMW32\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-m32 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
gcc %CFLAGS% -I%INCLUDE% -o objTDMW32\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -mwindows -L"%LIB%" %OBJS% objTDMW32\Debug\%NAME_APPLI%.o objTDMW32\Debug\%NAME_APPLI%.res -o binTDMW32\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
ar ru binTDMW32\Release\lib%NAME_APPLI%.a %OBJS% objTDMW32\Release\%NAME_APPLI%.o
gcc -m32 -o binTDMW32\Release\%NAME_APPLI%.lib %OBJS% objTDMW32\Release\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBLIB
set "CFLAGS=-m32 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
ar ru binTDMW32\Debug\lib%NAME_APPLI%.a %OBJS% objTDMW32\Debug\%NAME_APPLI%.o
gcc -m32 -o binTDMW32\Debug\%NAME_APPLI%.lib %OBJS% objTDMW32\Debug\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -I%INCLUDE% -o objTDMW32\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW32\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -shared -s -L"%LIB%" -Wl,--out-implib,binTDMW32\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objTDMW32\Release\%NAME_APPLI%.o objTDMW32\Release\%NAME_APPLI%.res -o binTDMW32\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBDLL
...
gcc %CFLAGS% -I%INCLUDE% -o objTDMW32\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objTDMW32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -shared -L"%LIB%" -Wl,--out-implib,binTDMW32\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objTDMW32\Debug\%NAME_APPLI%.o objTDMW32\Debug\%NAME_APPLI%.res -o binTDMW32\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
