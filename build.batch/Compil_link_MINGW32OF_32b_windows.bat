...
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objMINGW32OF\Release\%%a.o -c src\%%a.c
		 call :concat objMINGW32OF\Release\%%a.o
		 )
)
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -mconsole -s -L"%LIB%" %OBJS% objMINGW32OF\Release\%NAME_APPLI%.o objMINGW32OF\Release\%NAME_APPLI%.res -o binMINGW32OF\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m32 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         gcc %CFLAGS% -I%INCLUDE% -o objMINGW32OF\Debug\%%a.o -c src\%%a.c
		 call :concat objMINGW32OF\Debug\%%a.o
		 )
)
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -mconsole -L"%LIB%" %OBJS% objMINGW32OF\Debug\%NAME_APPLI%.o objMINGW32OF\Debug\%NAME_APPLI%.res -o binMINGW32OF\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -mwindows -s -L"%LIB%" %OBJS% objMINGW32OF\Release\%NAME_APPLI%.o objMINGW32OF\Release\%NAME_APPLI%.res -o binMINGW32OF\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-m32 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -mwindows -L"%LIB%" %OBJS% objMINGW32OF\Debug\%NAME_APPLI%.o objMINGW32OF\Debug\%NAME_APPLI%.res -o binMINGW32OF\Debug\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
ar ru binMINGW32OF\Release\lib%NAME_APPLI%.a %OBJS% objMINGW32OF\Release\%NAME_APPLI%.o
gcc -m32 -L"%LIB%" -o binMINGW32OF\Release\%NAME_APPLI%.lib %OBJS% objMINGW32OF\Release\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBLIB
set "CFLAGS=-m32 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
gcc -m32 -L"%LIB%" -o binMINGW32OF\Debug\%NAME_APPLI%.lib %OBJS% objMINGW32OF\Debug\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
gcc -m32 -shared -s -L"%LIB%" -Wl,--out-implib,binMINGW32OF\Release\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objMINGW32OF\Release\%NAME_APPLI%.o objMINGW32OF\Release\%NAME_APPLI%.res -o binMINGW32OF\Release\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBDLL
...
gcc %CFLAGS% -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INCLUDE% -o objMINGW32OF\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
gcc -m32 -shared -L"%LIB%" -Wl,--out-implib,binMINGW32OF\Debug\lib%NAME_APPLI%.a -W1,—export-all-symbols -Wl,—enable-auto-image-base -Wl,--subsystem,windows %OBJS% objMINGW32OF\Debug\%NAME_APPLI%.o objMINGW32OF\Debug\%NAME_APPLI%.res -o binMINGW32OF\Debug\%NAME_APPLI%.dll -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
