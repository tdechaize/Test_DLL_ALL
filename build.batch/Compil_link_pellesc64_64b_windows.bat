...
set "CFLAGS=/nologo /Tx64-coff /Ze /c /DNDEBUG /D_AMD64_ /D_WIN64"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         pocc %CFLAGS% /I%INC1% /I%INC2% /FoobjPellesC64\Release\%%a.obj src\%%a.c
		 call :concat objPellesC64\Release\%%a.o
		 )
)
pocc %CFLAGS% /I%INC1% /I%INC2% /FoobjPellesC64\Release\%NAME_APPLI%.obj src\%NAME_APPLI%.c
porc /I%INC1% /I%INC2% /FoobjPellesC64\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polink /nologo /SUBSYSTEM:CONSOLE /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" %OBJS% objPellesC64\Release\%NAME_APPLI%.obj objPellesC64\Release\%NAME_APPLI%.res /OUT:binPellesC64\Release\%NAME_APPLI%.exe glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
:DEBCONS
set "CFLAGS=/nologo /Tx64-coff  /Ze /c /Zi /DDEBUG /D_DEBUG /D_AMD64_ /D_WIN64"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         pocc %CFLAGS% /I%INC1% /I%INC2% /FoobjPellesC64\Debug\%%a.obj src\%%a.c
		 call :concat objPellesC64\Debug\%%a.o
		 )
)
pocc %CFLAGS% /I%INC1% /I%INC2% /FoobjPellesC64\Debug\%NAME_APPLI%.obj src\%NAME_APPLI%.c
porc /I%INC1% /I%INC2% /FoobjPellesC64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polink /nologo /DEBUG /SUBSYSTEM:CONSOLE /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" %OBJS% objPellesC64\Debug\%NAME_APPLI%.obj objPellesC64\Debug\%NAME_APPLI%.res /OUT:binPellesC64\Debug\%NAME_APPLI%.exe glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
...
pocc %CFLAGS% /I%INC1% /I%INC2% /FoobjPellesC64\Release\%NAME_APPLI%.obj src\%NAME_APPLI%.c
porc /I%INC1% /I%INC2% /FoobjPellesC64\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polink /nologo /SUBSYSTEM:WINDOWS /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" %OBJS% objPellesC64\Release\%NAME_APPLI%.obj objPellesC64\Release\%NAME_APPLI%.res /OUT:binPellesC64\Release\%NAME_APPLI%.exe glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
:DEBAPP
set "CFLAGS=/nologo /Tx64-coff  /Ze /c /Zi /DDEBUG /D_DEBUG /D_AMD64_ /D_WIN64"
if exist %1\src_c.txt (
...
pocc %CFLAGS% /I%INC1% /I%INC2% /FoobjPellesC64\Debug\%NAME_APPLI%.obj src\%NAME_APPLI%.c
porc /I%INC1% /I%INC2% /FoobjPellesC64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polink /nologo /DEBUG /SUBSYSTEM:WINDOWS /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" %OBJS% objPellesC64\Debug\%NAME_APPLI%.obj objPellesC64\Debug\%NAME_APPLI%.res /OUT:binPellesC64\Debug\%NAME_APPLI%.exe glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
...
polib /MACHINE:X64 /out:binPellesC64\Release\%NAME_APPLI%.lib %OBJS% objPellesC64\Release\%NAME_APPLI%.obj
goto FIN
:DEBLIB
set "CFLAGS=/nologo /Tx64-coff /Ze /c /Zi /DDEBUG /D_DEBUG /D_AMD64_ /D_WIN64"
if exist %1\src_c.txt (
...
polib /MACHINE:X64 /out:binPellesC64\Debug\%NAME_APPLI%.lib %OBJS% objPellesC64\Debug\%NAME_APPLI%.obj
goto FIN

:DLLA
echo "Pelles C 64bits -> Genération d'une librairie partagée (.ie. DLL) en mode : %4"
if "%4"=="Debug" goto DEBDLL
set "FLAGS=/nologo /Tx64-coff /Ze /c /DNDEBUG /D_AMD64_ /D_WIN64"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         pocc %CFLAGS% /I%INC1% /I%INC2% /FoobjPellesC64\Release\%%a.obj src\%%a.c
		 call :concat objPellesC64\Release\%%a.o
...
pocc %CFLAGS% /I%INC1% /I%INC2% /FoobjPellesC64\Release\%NAME_APPLI%.obj src\%NAME_APPLI%.c
porc /I%INC1% /I%INC2% /FoobjPellesC64\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
polink /nologo /Dll /MACHINE:X64 /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" /IMPLIB:binPellesC64\Release\%NAME_APPLI%.lib %OBJS% objPellesC64\Release\%NAME_APPLI%.obj objPellesC64\Release\%NAME_APPLI%.res /OUT:binPellesC64\Release\%NAME_APPLI%.dll glu32.lib opengl32.lib gdi32.lib advapi32.lib comdlg32.lib winmm.lib user32.lib kernel32.lib
goto FIN
:DEBDLL
set "FLAGS=/nologo /Tx64-coff /Ze /c /Zi /DDEBUG /D_DEBUG /D_AMD64_ /D_WIN64"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         pocc %CFLAGS% /I%INC1% /I%INC2% /FoobjPellesC64\Debug\%%a.obj src\%%a.c
		 call :concat objPellesC64\Debug\%%a.o
