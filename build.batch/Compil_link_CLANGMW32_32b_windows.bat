...
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         clang %CFLAGS% -I%INC1% -I%INC2% -o objCLANGMW32\Release\%%a.o -c src\%%a.c
		 call :concat objCLANGMW32\Release\%%a.o
		 )
)
clang %CFLAGS% -I%INC1% -I%INC2% -o objCLANGMW32\Release\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INC1% -I%INC2% -o objCLANGMW32\Release\%NAME_APPLI%.res -i src\%NAME_APPLI%.rc
clang -m32 -s -L%LIB% %OBJS% objCLANGMW32\Release\%NAME_APPLI%.o objCLANGMW32\Release\%NAME_APPLI%.res -o binCLANGMW32\Release\%NAME_APPLI%.exe -Wl,--subsystem,console -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-m32 -O0 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         clang %CFLAGS% -I%INC1% -I%INC2% -o objCLANGMW32\Debug\%%a.o -c src\%%a.c
		 call :concat objCLANGMW32\Debug\%%a.o
		 )
)
clang %CFLAGS% -I%INC1% -I%INC2% -o objCLANGMW32\Debug\%NAME_APPLI%.o -c src\%NAME_APPLI%.c
windres -J rc -O coff -I%INC1% -I%INC2% -o objCLANGMW32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m32 -L%LIB% %OBJS% objCLANGMW32\Debug\%NAME_APPLI%.o objCLANGMW32\Debug\%NAME_APPLI%.res -o binCLANGMW32\Debug\%NAME_APPLI%.exe -Wl,--subsystem,console -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
...
clang -m32 -L%LIB% -o binCLANGMW32\Release\%NAME_APPLI%.lib objCLANGMW32\Release\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
:DEBLIB
set "CFLAGS=-m32 -O0 -g -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
clang -m32 -L%LIB% -o binCLANGMW32\Debug\%NAME_APPLI%.lib objCLANGMW32\Debug\%NAME_APPLI%.o -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -lkernel32
goto FIN
