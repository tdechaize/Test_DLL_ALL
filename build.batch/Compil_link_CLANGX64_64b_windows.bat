...
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         clang %CFLAGS% -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%"-I %INC3% -I %INC4% -I %INC5% -o objCLANGX64\Release\%%a.obj -c src\%%a.c
		 call :concat objCLANGX64\Release\%%a.obj
		 )
)
clang %CFLAGS% -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%"- I%INC3% -I%INC4% -I%INC5% -o objCLANGX64\Release\%NAME_APPLI%.obj -c src\%NAME_APPLI%.c
rc /nologo /i"%INC1%" /i"%INC2%" /i"%INC3%" /i"%INC4%" /i"%INC5%" /fo objCLANGX64\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m64 -fms-extensions -target x86_64-pc-windows-msvc -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" %OBJS% objCLANGX64\Release\%NAME_APPLI%.obj objCLANGX64\Release\%NAME_APPLI%.res -o binCLANGX64\Release\%NAME_APPLI%.exe -Wl,--subsystem,console -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
:DEBCONS
set "CFLAGS=-O0 -m64 -fms-extensions -target x86_64-pc-windows-msvc -g -gcodeview -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
   for /f "tokens=* delims=" %%a in ('type %1\src_c.txt') do (
         clang %CFLAGS% -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%"-I %INC3% -I %INC4% -I %INC5% -o objCLANGX64\Debug\%%a.obj -c src\%%a.c
		 call :concat objCLANGX64\Debug\%%a.obj
		 )
)
clang %CFLAGS% -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%" -o objCLANGX64\Debug\%NAME_APPLI%.obj -c src\%NAME_APPLI%.c
rc /nologo /i"%INC1%" /i"%INC2%" /i"%INC3%" /i"%INC4%" /i"%INC5%" /fo objCLANGX64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m64 -fms-extensions -target x86_64-pc-windows-msvc -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" %OBJS% objCLANGX64\Debug\%NAME_APPLI%.obj objCLANGX64\Debug\%NAME_APPLI%.res -o binCLANGX64\Debug\%NAME_APPLI%.exe -Wl,--subsystem,console -Wl,/debug,/pdb:%NAME_APPLI%.pdb -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
...
clang %CFLAGS% -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%" -o objCLANGX64\Release\%NAME_APPLI%.obj -c src\%NAME_APPLI%.c
rc /nologo /i"%INC1%" /i"%INC2%" /i"%INC3%" /i"%INC4%" /i"%INC5%" /fo objCLANGX64\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m64 -fms-extensions -target x86_64-pc-windows-msvc -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" %OBJS% objCLANGX64\Release\%NAME_APPLI%.obj objCLANGX64\Release\%NAME_APPLI%.res -o binCLANGX64\Release\%NAME_APPLI%.exe -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
:DEBAPP
set "CFLAGS=-O0 -m64 -fms-extensions -target x86_64-pc-windows-msvc -g -gcodeview -DDEBUG -D_DEBUG"
if exist %1\src_c.txt (
...
clang %CFLAGS% -I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%" -o objCLANGX64\Debug\%NAME_APPLI%.obj -c src\%NAME_APPLI%.c
rc /nologo /i"%INC1%" /i"%INC2%" /i"%INC3%" /i"%INC4%" /i"%INC5%" /fo objCLANGX64\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
clang -m64 -fms-extensions -target x86_64-pc-windows-msvc -L"%LIB1%" -L"%LIB2%" -L"%LIB3%" -L"%LIB4%" -L"%LIB5%" %OBJS% objCLANGX64\Debug\%NAME_APPLI%.obj objCLANGX64\Debug\%NAME_APPLI%.res -o binCLANGX64\Debug\%NAME_APPLI%.exe -Wl,/debug,/pdb:%NAME_APPLI%.pdb -lglu32 -lopengl32 -ladvapi32 -lcomdlg32 -lgdi32 -lwinmm -luser32 -lkernel32
goto FIN
