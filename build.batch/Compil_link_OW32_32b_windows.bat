...
wlink option quiet debug all system nt_win CON LIBP "%LIB1%";"%LIB2%" file %OBJS% objOW32\Debug\%NAME_APPLI%.obj option resource=objOW32\Debug\%NAME_APPLI%.res name binOW32\Debug\%NAME_APPLI%.exe library glu32,opengl32,advapi32,comdlg32,gdi32,winmm,user32,kernel32
goto FIN
...
wcl386 %CFLAGS% -i%INC1% -i%INC2% -fo=objOW32\Release\%NAME_APPLI%.obj src\%NAME_APPLI%.c
wrc -q -r -i%INC1% -i%INC2% -fo=objOW32\Release\%NAME_APPLI%.res src\%NAME_APPLI%.rc
wlink option quiet system nt_win  LIBP "%LIB1%";"%LIB2%"  IMPLIB binOW32\Release\%NAME_APPLI%.lib file %OBJS% objOW32\Release\%NAME_APPLI%.obj option resource=objOW32\Release\%NAME_APPLI%.res name binOW32\Release\%NAME_APPLI%.dll library glu32,opengl32,advapi32,comdlg32,gdi32,winmm,user32,kernel32
goto FIN
:DEBDLL
...
wcl386 %CFLAGS% -i%INC1% -i%INC2% -fo=objOW32\Debug\%NAME_APPLI%.obj src\%NAME_APPLI%.c
wrc -q -r -i%INC1% -i%INC2% -fo=objOW32\Debug\%NAME_APPLI%.res src\%NAME_APPLI%.rc
wlink option quiet debug all system nt_win  LIBP "%LIB1%";"%LIB2%"  IMPLIB binOW32\Debug\%NAME_APPLI%.lib file %OBJS% objOW32\Debug\%NAME_APPLI%.obj option resource=objOW32\Debug\%NAME_APPLI%.res name binOW32\Debug\%NAME_APPLI%.dll library glu32,opengl32,advapi32,comdlg32,gdi32,winmm,user32,kernel32
goto FIN
